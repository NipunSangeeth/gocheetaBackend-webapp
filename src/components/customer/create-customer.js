...
function Register() {
    ...
    const handelSubmit = (e) => {
        ...
        if (handleValidation() === true) {
            ...
            axios.post('/customer/save', dataObject,)
                .then((res) => {
                    ...
                    if (res.data.code === 200) {
                        ...
                        toast.success('Customer create successfully!', { position: toast.POSITION.TOP_RIGHT })
        ...
        <>
            ...
            <Row className="">
                ...
                <Col lg={10} md={10} sm={10} className="shadow-sm rounded-lg test-left p-5">
                    ...
                    <h3 className="dashboard">Create Customer</h3>
                    <hr></hr>
                                ...
                                <div className='row'>
                                    <div className="col-lg-6 md-6 xs-12">
                                        <Form.Group controlId="formBasicUserName" className="mt-3">
                                            ...
                                            <Form.Control onChange={e => setuname(e.target.value)} type="text" placeholder="Address Line" />
                                        </Form.Group>
